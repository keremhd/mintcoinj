...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    private volatile int vMinRequiredProtocolVersion = Pong.MIN_PROTOCOL_VERSION; // MintCoin 1.7 supports protocol v60006. See https://code.google.com/p/bitcoinj/issues/detail?id=421
